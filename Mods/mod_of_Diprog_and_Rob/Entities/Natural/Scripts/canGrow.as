...
bool canGrowAt( CBlob@ this, Vec2f pos)
{
    ...
    {
        if (this.isInWater() || this.isAttached() || !isNotTouchingOthers(this)) {
            return false;
        }
    }
	...
	CBlob@ blob;
	@blob = map.getBlobAtPosition(Vec2f(pos.x, pos.y+8));
	if (blob !is null && blob.getConfig() == "farming_block") return true;
