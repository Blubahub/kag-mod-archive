...
void onTick(CBlob@ this)
{
	...
	if(this.isKeyJustPressed(key_action2) && !this.isInWater())if(getNet().isServer()){
		CBlob @newBlob = server_CreateBlob("mansshadow", this.getTeamNum(), this.getPosition());
...
void DoAttack(CBlob@ this, f32 damage, f32 aimangle, f32 arcdegrees, u8 type, int deltaInt)
{
	...
	f32 attack_distance = Maths::Min(8 + Maths::Max(0.0f, 1.75f * this.getShape().vellen * (vel * thinghy)), 8);
