...
{
    RunnerTextures@ runner_tex = addRunnerTextures(this, "crossbowman", "Crossbowman");
...
void LoadSprites( CSprite@ this )
{
    ...
    CSpriteLayer@ arrow = this.addSpriteLayer( "held arrow", "HunterArrow.png" , 16, 8, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
