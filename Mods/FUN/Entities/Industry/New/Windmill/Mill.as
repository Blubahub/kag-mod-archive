...
void onTick(CBlob@ this)
{
	...
	if (this.hasTag("producing")) windmill.RotateBy(2.3435, Vec2f_zero);
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	...
	if (cmd == this.getCommandID("start"))
	{
		...
		this.Tag("producing");
		this.AddScript("MillProduce.as");
	}
	if (cmd == this.getCommandID("add grain") && getNet().isServer())
	{
...
void PickUpIntoMill( CBlob@ this )
{
	...
	if (map.getBlobsInRadius( this.getPosition(), this.getRadius()*1.5f, @blobsInRadius ) && !this.hasTag("producing") )
	{
